#!/bin/sh
docker run -d --name elasticsearch -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" -v /tank/esdata:/usr/share/elasticsearch/data:Z  docker.elastic.co/elasticsearch/elasticsearch:7.3.0
